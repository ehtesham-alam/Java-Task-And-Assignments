...
class PoundToOunce extends JFrame implements ActionListener {
	JFrame jFrame = new JFrame();
	JLabel jLabel = new JLabel("Enter Pound");
	JButton jButton = new JButton("convert to Ounce");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == jButton) {
			String pound = jTextfield.getText();
			int pd = Integer.parseInt(pound);
			int result = pd * 16;
