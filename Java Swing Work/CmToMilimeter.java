...
class CmToMilimeter extends JFrame implements ActionListener {
	JFrame jFrame = new JFrame();
	JLabel jLabel = new JLabel("Enter Centimeter");
	JButton jButton = new JButton("convert to Milimeter");
