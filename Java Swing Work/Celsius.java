...
class Celsius extends JFrame implements ActionListener {
	JFrame jFrame = new JFrame();
	JLabel jLabel = new JLabel("Enter celsius");
	JButton jButton = new JButton("convert to kelvin");
