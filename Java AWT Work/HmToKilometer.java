...
class HmToKilometer extends Frame implements ActionListener {
	Frame Frame = new Frame();
	Label Label = new Label("Enter HectoMeter");
	Button Button = new Button("Convert to kilomMter");
