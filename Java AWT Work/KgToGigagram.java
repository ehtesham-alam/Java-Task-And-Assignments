...
class KgToGigagram extends Frame implements ActionListener {
	Frame Frame = new Frame();
	Label Label = new Label("Enter KiloGram");
	Button Button = new Button("convert to Gigagram");
	...
	KgToGigagram() {
		...
		Textfield.setBounds(120,70,100,30);
		Label3.setBounds(80,175,90,30);
