...
class GuideDemo2 extends Frame {
	  ...
	  GuideDemo2() {
				...
				fram.setBounds(1230,0,100,100);
				fram1.setBounds(1100,100,100,100);
				fram2.setBounds(970,200,100,100);
				fram3.setBounds(840,300,100,100);
				fram4.setBounds(710,400,100,100);
				fram5.setBounds(580,500,100,100);
				fram6.setBounds(450,600,100,100);
